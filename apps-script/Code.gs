...
function publishSheet() {
  // 이 함수 실행 후, Google Sheets에서 수동으로:
  // 파일 → 공유 → 웹에 게시 → 전체 문서 → 게시
  ...
  console.log('');
  console.log('발행 후 데이터 읽기 URL:');
  console.log('https://docs.google.com/spreadsheets/d/' + CONFIG.SPREADSHEET_ID + '/gviz/tq?tqx=out:json&sheet=newsletters');
}
